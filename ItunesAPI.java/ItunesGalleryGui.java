...
public class GalleryApp extends Application {
    ...
    public void about(){
        ...
        ImageView me = new ImageView("https://scontent-atl3-1.xx.fbcdn.net/v/t1.0-9/12509462_938562746193383_3868851843012217376_n.jpg?oh=940503fce19fd7ee6dc034179b0878ed&oe=5AAD2E92");

        me.setFitWidth(100);
        me.setFitHeight(100);
        me.setPreserveRatio(true);

        Text name = new Text("Name: Harli Bott");
        Text email = new Text("Student Email: hjb15032@uga.edu");
